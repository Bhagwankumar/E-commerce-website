    ...
    $brand_id=$_GET['brand'];
      $select_query="Select * from `products` where brand_id=$brand_id";
            ...
            while($row=mysqli_fetch_assoc($result_query)){
              ...
              <!---<div class='col-md-4'>
              <div class='card'>
                    <img src='./admin_area/product_image/<?=$items ['product_image1'] ?> class="card-img-top" <?="$product_title"?>
                    <div class="card-body">
                      <h5 class="card-title"> <?= $product_title?> </h5>
                      <p class="card-text"> <?= $product_description ?> </p>
                      <a href='index.php?add_to_cart=$product_id' class='btn btn-info'>Add to cart</a>
...
function getbrands(){
  ...
  $select_brands="Select * from `brands`";
          ...
          while($row_data=mysqli_fetch_assoc($result_brands)){
                ...
                echo "<li class='navbar nav-item'>
                <a href='index.php?brand=$brand_id' id='link'class='nav-link text-center'><h4>$brand_title</h4></a>
              </li>";
          }
}

//display catagories in sidenav
...
function getcategories(){
  ...
  $select_categories="Select * from `categories`";
        ...
        while($row_data=mysqli_fetch_assoc($result_categories)){
          ...
          echo "<li class='navbar nav-item '>
          <a href='index.php?category=$category_id' id='link'class='nav-link text-center'><h4>$category_title</h4></a>
        </li>";
        }
}
...
function cart_item(){
 ...
 function total_cart_price(){
  ...
  $get_ip_add = getIPAddress(); 
  $total_price=0;
  $cart_details="Select * from `cart_details` where ip_address='$get_ip_add'";
  $result=mysqli_query($con,$cart_details);
