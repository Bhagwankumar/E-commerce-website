...
<!--fourth child-->
  ...
  <div class="card-body">
    ...
    <a href="#" class="btn btn-secondary">View more</a>
        ...
        <div class="col-md-4">
          <div class="card" style="width: 18rem;">
  <img src="./images/fabian-heimann-4R_WEmhx8og-unsplash.jpg" style="oject-fit:cover;" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="index.php?add_to_cart" class="btn btn-info">Add to cart</a>
...
<div class="col-md-4">
  ...
  <img src="./images/t-shirt3.jpg" style="object-fit:cover;"class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="index.php?add_to_cart" class="btn btn-info">Add to cart</a>
